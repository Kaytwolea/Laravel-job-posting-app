                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Kindly enter {{$data->reset_code}} as your confirmation code to reset your password<a href="https://blogdesire.com">If you did not request this</a>, you can safely delete
                                this email.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
